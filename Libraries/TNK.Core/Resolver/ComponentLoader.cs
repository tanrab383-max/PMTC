...
namespace TNK.Core.Resolver
{
    ...
    internal class RegisterComponent : IRegisterComponent
    {
        ...
        public void RegisterType<TFrom, TTo>(string connectionString) where TTo : TFrom
        {
            this._container.RegisterType<TFrom, TTo>(new HierarchicalLifetimeManager(), new InjectionConstructor(connectionString));
        }

        public void CustomRegisterType<TFrom, TTo>() where TTo : TFrom
        {
